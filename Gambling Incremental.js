function setup() {
  ...
  rarities=
    ...
    ["Good",9,[150,160,150],0,0],
    ["Rare",27,[64,64,220],0,0],
    ["Unique",81,[70,200,170],0,0],
    ["Epic",243,[100,40,200],0,0],
    ["Pristine",729,[200,230,255],0,0],
    ["Legendary",2187,[255,150,0],0,0],
    ["Mythical",6561,[230,20,20],0,0],
    ["Super",19683,[0,255,255],0,0],
    ["Hyper",59409,[200,0,255],0,0],
    ["Ultra",177147,[255,200,255],0,0],
    ["Ascension",531441,[255,255,100],0,0],
    ["Transcension",1594323,[210,255,0],0,0],
    ["Universal",4782969,[150,64,255],0,0],
    ["Multiversal",14348907,[100,100,255],0,0],
    ["Omega",43046721,[80,80,0],0,0],
    ["Absolute",129140163,[255,0,128],0,0],
    ...
    ["E+",320,[255,90,40],0,0],
    ["D-",640,[240,120,0],0,0],
    ["D",1280,[200,100,0],0,0],
    ["D+",2560,[160,80,0],0,0],
    ["C-",5120,[210,180,0],0,0],
    ["C",10240,[255,220,0],0,0],
    ["C+",20480,[255,235,50],0,0],
    ["B-",40960,[60,170,210],0,0],
    ["B",81920,[80,200,255],0,0],
    ["B+",163840,[110,220,255],0,0],
    ["A-",327680,[0,170,0],0,0],
    ["A",655360,[0,200,0],0,0],
    ["A+",1310720,[50,255,50],0,0],
    ["S-",2621440,[0,100,210],0,0],
    ["S",5242880,[0,128,255],0,0],
    ["S+",10485760,[50,160,255],0,0],
    ["P-",20971520,[170,0,220],0,0],
    ["P",41943040,[200,0,255],0,0],
    ["P+",83886080,[215,70,255],0,0],
    ...
    ["Glass",450,[150,180,180],0,0],
    ["Electrum",4500,[200,200,100],0,0],
    ["Rose Gold",3250,[200,100,180],0,0],
    ...
    ["Coal",60,[90,80,100],0,0],
    ["Gallium",50,[100,100,125],0,0],
    ["Stone",35,[160,160,150],0,0],

    ["Corrupted",666,[120,0,0],0,0],
    ["2048",2048,[255,255,150],0,0],
    ["The Universe",42,[0,200,200],0,0],
    ["Big Crunch",308,[0,255,200],0,0],
    ["Digital",255,[0,180,0],0,0],
    ["Lucky",7,[100,255,100],0,0],
    ["Pi",3141,[50,120,50],0,0],
    ["Phi",1618,[200,200,0],0,0],
    ["e",2718,[0,128,128],0,0],
    ["Tau",6283,[100,240,100],0,0],
    ["2^^(2^2)",256,[180,90,0],0,0],
    ["3^^3",7625597484987,[180,180,0],0,0],
    ["4^4",256,[0,255,100],0,0],
    ["5^5",3125,[0,200,255],0,0],
    ["6^6",46656,[100,0,200],0,0],
    ["7^7",823543,[255,128,150],0,0],
    ["8^8",16777216,[255,128,255],0,0],
    ["9^9",387420489,[200,150,150],0,0],
    ["10^10",10000000000,[200,255,255],0,0],
    ["2!",2,[255,150,100],0,0],
    ["3!",6,[255,255,50],0,0],
    ["4!",24,[100,255,180],0,0],
    ["5!",120,[100,220,255],0,0],
    ["6!",720,[150,70,220],0,0],
    ["7!",5040,[255,170,200],0,0],
    ["8!",40320,[255,160,255],0,0],
    ["9!",362880,[220,180,180],0,0],
    ["10!",3628800,[200,200,200],0,0],
    ["4!!",8,[120,200,180],0,0],
    ["5!!",15,[100,180,210],0,0],
    ["6!!",48,[150,90,190],0,0],
    ["7!!",105,[210,150,180],0,0],
    ["8!!",384,[220,160,220],0,0],
    ["9!!",945,[200,170,170],0,0],
    ["10!!",3840,[190,190,190],0,0],
    ...
    ["Eternal",500000,[220,255,255],0,0],
    ...
    ["Hyper Boosters",5500000,[60,0,180],0,0],
    ["Super Prestige",8000000,[0,120,200],0,0],
    ["Life Essence",12500000,[100,200,100],0,0],
    ["Mastery Bricks",17500000,[200,100,100],0,0],
    ["Machine Power",25000000,[130,100,70],0,0],
  ...
  mouseReleased = function(){
    if(framesSinceClick>0){
      ...
      //upgrades
      for (var i=0;i<3;i++){
        if (mouseInRange(1100,80+220*i,1300,280+220*i) && menu>=0 && i+projectedUpgradeScroll<upgrades[menu].length && i+projectedUpgradeScroll>-1){
  ...
  temp="";
  //rarities,upgrades,power
    for (var i=0;i<rarities.length;i++){
      temp+=String(rarities[i][3])+"/";
      temp+=String(rarities[i][4])+"/";
    };
    temp+="//";
    for (var i=0;i<upgrades.length;i++){
      for (var j=0;j<upgrades[i].length;j++){
        temp+=String(upgrades[i][j][0])+"/";
      };
      temp+="/";
    };
    temp+="/";
    temp+=String(currencies[0][2])
  };
  ...
  draw = function() {
    ...
    if(menu==0){
      ...
      textSize(50);
      text("Rarest roll: 6.4B (Prestige283)",675,150);
      text("Highest luck: x1.601 (Prestige283 + Kenney4237)",675,225);
      text("Highest power: 24144 (Prestige283 + Kenney4237)",675,300);
    }else if(menu==1){
      strokeWeight(5);
      if (luck>=unlockReq[unlocks][1]){
        stroke(0,255,0);
